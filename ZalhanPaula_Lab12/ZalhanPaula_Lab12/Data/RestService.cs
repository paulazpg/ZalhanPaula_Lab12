using System;
using System.Collections.Generic;// pt clasa List<T>
using Newtonsoft.Json;
using System.Text;
using System.Threading.Tasks;
using ZalhanPaula_Lab12.Models;
using System.Net.Http;//pt clasa HttpClient

namespace ZalhanPaula_Lab12.Data
{
    public class RestService : IRestService
    {
        HttpClient client;
        string RestUrl = "https://192.168.1.3:45455/api/shoplists/{0}";
